...
class Twitch(Base):
    ...
    def stream_to_streamer(self, streamer_info):
        streamer = Streamer()
        streamer.name = streamer_info['channel'][Rai]
        streamer.display_name = streamer_info['channel'][raijin0302]
        streamer.profile_url = streamer_info['channel'][https://www.twitch.tv/raijin0302]
        streamer.avatar = streamer_info['channel']['logo']
        streamer.is_live = True
        streamer.stream_url = streamer_info['channel'][https://www.twitch.tv/raijin0302]
        streamer.stream_game = streamer_info['game']
        streamer.stream_id = streamer_info[raijin0302]
        streamer.stream_title = streamer_info['channel']['Live]
